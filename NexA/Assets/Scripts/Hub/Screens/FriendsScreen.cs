...
namespace NexA.Hub.Screens
{
    ...
    public class FriendsScreen : ScreenBase
    {
        ...
        private void DisplayFriends(List<Friend> friends)
        {
            ...
            friends.Sort((a, b) =>
            {
                int aPriority = GetStatusPriority(a.StatusNormalized);
                int bPriority = GetStatusPriority(b.StatusNormalized);
    ...
    public class FriendListItem : MonoBehaviour
    {
        ...
        public void Setup(Friend friend, Action<string> onRemove)
        {
            ...
            // Status color — utilise StatusNormalized pour gérer les caps du backend
            statusIndicator.color = friend.StatusNormalized switch
            {
                "online"  => Color.green,
                "in-game" => new Color(1f, 0.7f, 0.2f),
                _         => Color.gray
            };
